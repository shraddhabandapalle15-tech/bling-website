...
export default function Shop() {
  ...
  const pillBase: CSSProperties = {
    fontFamily: SANS, fontSize: TEXT_SM, borderRadius: 100, padding: "8px 16px", cursor: "pointer",
    ...
    <section style={{ background: BG, paddingTop: 72, minHeight: "100vh" }}>
      ...
      <div className="shopLayout" style={{ maxWidth: 1280, margin: "0 auto", padding: "28px 24px 100px", display: "grid", gridTemplateColumns: "260px 1fr", gap: 40, alignItems: "start" }}>
        ...
        <aside className="shopSidebar" style={{ position: "sticky", top: 96, background: "#fff", borderRadius: 24, padding: 24, boxShadow: "0 4px 20px rgba(0,0,0,.05)" }}>
          <div style={{ fontFamily: DISPLAY, fontSize: TEXT_XS, letterSpacing: "1px", textTransform: "uppercase", color: INK, opacity: .5, marginBottom: 14 }}>Color</div>
          ...
          <div style={{ fontFamily: DISPLAY, fontSize: TEXT_XS, letterSpacing: "1px", textTransform: "uppercase", color: INK, opacity: .5, marginBottom: 14 }}>Price</div>
          <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 26, fontFamily: SANS, fontSize: TEXT_BASE, color: INK }}>
          ...
          <div style={{ fontFamily: DISPLAY, fontSize: TEXT_XS, letterSpacing: "1px", textTransform: "uppercase", color: INK, opacity: .5, marginBottom: 14 }}>Availability</div>
          <label style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer", fontFamily: SANS, fontSize: TEXT_BASE, color: INK }}>
        ...
        <div>
          <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 20 }}>
            <select value={sort} onChange={e => setSort(e.target.value as Sort)}
              style={{ fontFamily: SANS, fontSize: TEXT_SM, color: INK, background: "#fff", border: "1.5px solid rgba(23,23,23,.16)", borderRadius: 100, padding: "9px 18px", cursor: "pointer" }}>
