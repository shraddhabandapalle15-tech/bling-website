    ...
    <section style={{ background: BG, paddingTop: 72, minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "24px 24px 0" }}>
        <div style={{
          ...
          <span style={{ background: "#fff", color: INK, borderRadius: 100, padding: "8px 18px", fontFamily: DISPLAY, fontSize: TEXT_XS, letterSpacing: ".5px", textTransform: "uppercase" }}>
            {recipe.category}
          </span>
        </div>
        ...
        <div className="stepGrid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, marginBottom: 64 }}>
          <div>
            <h2 style={{ fontFamily: DISPLAY, fontSize: TEXT_2XL, color: HEADING_INK, margin: "0 0 18px", letterSpacing: "-.3px" }}>Ingredients</h2>
            <ul style={{ margin: 0, padding: 0, listStyle: "none" }}>
              {recipe.ingredients.map((ing, i) => (
                <li key={i} style={{ display: "flex", alignItems: "flex-start", gap: 10, fontFamily: SANS, fontSize: TEXT_MD, color: INK, opacity: .78, lineHeight: 1.6, marginBottom: 12 }}>
          ...
          <div>
            <h2 style={{ fontFamily: DISPLAY, fontSize: TEXT_2XL, color: HEADING_INK, margin: "0 0 18px", letterSpacing: "-.3px" }}>Steps</h2>
              ...
              {recipe.steps.map((step, i) => (
                <li key={i} style={{ display: "flex", alignItems: "flex-start", gap: 14, marginBottom: 18 }}>
                  <span style={{
                    ...
                    display: "flex", alignItems: "center", justifyContent: "center", fontFamily: DISPLAY, fontSize: TEXT_XS,
                  }}>{i + 1}</span>
                  <span style={{ fontFamily: SANS, fontSize: TEXT_MD, color: INK, opacity: .78, lineHeight: 1.6, paddingTop: 3 }}>{step}</span>
                </li>
              ))}
            </ol>
          </div>
        ...
        {product && (
          <div style={{ paddingBottom: 96 }}>
            <h2 style={{ fontFamily: DISPLAY, fontSize: TEXT_2XL, color: HEADING_INK, margin: "0 0 20px", letterSpacing: "-.3px" }}>Recommended Glitter</h2>
